    ...
    return(
        <>
            ...
            <div className="user">
                ...
                <img style={{visibility: imageIsLoading ? "hidden" : "visible"}} onLoad={() => setImageIsLoading(false)} className="user__photo" src={`https://picsum.photos/seed/${user.id}/400`} alt="profile pic"/>
                    <div className="user__info">
                        ...
                        <h3>
                            Website: <a href={`https://www.${user.website}`}> {user.website} </a>
                        </h3>
                    </div>
                </div>
